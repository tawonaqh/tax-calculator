          ...
          >
                ...
                >
                  ...
                  <div className="space-y-4">
                    <div className="flex justify-between items-center">
                      <span className="text-gray-300">Royalty Amount:</span>
            ...
            <div className="bg-gray-800/40 backdrop-blur-sm rounded-3xl border border-gray-700/50 p-6">
              ...
              <div className="space-y-3 text-sm text-gray-300">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-gray-400">5-10% with DTA</span>
                </div>
                <div className="flex justify-between">
            ...
            <div className="bg-gray-800/40 backdrop-blur-sm rounded-3xl border border-gray-700/50 p-6">
              ...
              <div className="text-sm text-gray-300 space-y-2">
                <p>Zimbabwe has DTAs with multiple countries including:</p>
