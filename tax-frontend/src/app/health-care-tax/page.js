          ...
          >
                ...
                >
                  ...
                  <div className="space-y-4">
                    <div className="flex justify-between items-center">
                      <span className="text-gray-300">Healthcare Value:</span>
                    ...
                    <div className="flex justify-between items-center">
                      <span className="text-gray-300">Healthcare Tax:</span>
            ...
            <div className="bg-gray-800/40 backdrop-blur-sm rounded-3xl border border-gray-700/50 p-6">
              ...
              <div className="space-y-3 text-sm text-gray-300">
                <div className="flex justify-between">
                  ...
                  <span className="text-lime-400 font-semibold">VAT applicable</span>
                </div>
                <div className="flex justify-between">
                  <span>Essential Drugs:</span>
                  <span className="text-gray-400">Often exempt</span>
                </div>
                <div className="flex justify-between">
                  <span>Medical Equipment:</span>
                  <span className="text-gray-400">Varies by type</span>
                </div>
                <div className="flex justify-between">
            ...
            <div className="bg-gray-800/40 backdrop-blur-sm rounded-3xl border border-gray-700/50 p-6">
              <div className="flex items-center gap-2 mb-3">
                <Stethoscope className="w-4 h-4 text-lime-400" />
                <h3 className="text-lg font-bold text-lime-400">
                  Healthcare Services
                </h3>
              </div>
              <div className="text-sm text-gray-300 space-y-2">
                <p>Tax applies to various healthcare services:</p>
