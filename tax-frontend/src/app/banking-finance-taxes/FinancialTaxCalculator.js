          ...
          <div className="bg-white rounded-3xl p-8 border border-[#FFD700] shadow-2xl">
            <div className="flex items-center justify-center gap-4 mt-4 mb-6">
              <div className="p-4 bg-gradient-to-r from-[#1ED760]/10 to-[#1ED760]/5 rounded-3xl shadow-lg">
                <TrendingUp className="w-12 h-12 text-[#1ED760]" />
              </div>
              <div>
          ...
          >
                ...
                >
                  ...
                  <div className="space-y-4">
                    <div className="flex justify-between items-center">
                      <span className="text-[#0F2F4E]">Financial Value:</span>
                    ...
                    <div className="flex justify-between items-center">
                      <span className="text-[#0F2F4E]">Financial Tax:</span>
            ...
            <div className="bg-white rounded-3xl border border-[#FFD700] p-6 shadow-lg">
              ...
              <div className="space-y-3 text-sm text-[#0F2F4E]">
                <div className="flex justify-between">
                  ...
                  <span className="text-[#1ED760] font-semibold">0.05%</span>
                </div>
                <div className="flex justify-between">
                  <span>Corporate Tax:</span>
                  <span className="text-[#0F2F4E]/70">24.72%</span>
                </div>
                <div className="flex justify-between">
                  <span>Capital Gains:</span>
                  <span className="text-[#0F2F4E]/70">20%</span>
                </div>
                <div className="flex justify-between">
                  <span>Filing Frequency:</span>
                  <span className="text-[#0F2F4E]/70">Monthly/Quarterly</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-3xl border border-[#FFD700] p-6 shadow-lg">
              <div className="flex items-center gap-2 mb-3">
                <PieChart className="w-4 h-4 text-[#1ED760]" />
                <h3 className="text-lg font-bold text-[#0F2F4E]">
                  Applicable Institutions
                </h3>
              </div>
              <div className="text-sm text-[#0F2F4E] space-y-3">
                <p className="text-[#0F2F4E]/80">Financial taxes apply to:</p>
                <div className="space-y-2">
            ...
            <div className="bg-white rounded-3xl border border-[#FFD700] p-6 shadow-lg">
              ...
              <ul className="space-y-2 text-sm text-[#0F2F4E]">
                <li className="flex items-start gap-2">
                  ...
                  <span>Register with relevant regulatory authorities</span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="w-1.5 h-1.5 bg-[#1ED760] rounded-full mt-1.5 flex-shrink-0" />
                  <span>Submit regular financial tax returns</span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="w-1.5 h-1.5 bg-[#1ED760] rounded-full mt-1.5 flex-shrink-0" />
                  <span>Maintain detailed transaction records</span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="w-1.5 h-1.5 bg-[#1ED760] rounded-full mt-1.5 flex-shrink-0" />
                  <span>Comply with anti-money laundering regulations</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white rounded-3xl border border-[#FFD700] p-6 shadow-lg">
              ...
              <div className="space-y-3 text-sm text-[#0F2F4E]">
                ...
                <div className="flex justify-between items-center">
                  <span>Capital Gains:</span>
                  <span className="text-[#1ED760] font-semibold">20%</span>
                </div>
                <div className="flex justify-between items-center">
